...
return json_decode( '{
	...
	"Andika": {
		...
		"category": "sans-serif",
		"variants": ["regular"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "latin"]
	},
	"Angkor": {
		"family": "Angkor",
		"category": "display",
	...
	"Anonymous Pro": {
		...
		"category": "monospace",
		"variants": ["regular", "italic", "700", "700italic"],
		"subsets": ["latin-ext", "cyrillic", "latin", "greek"]
	},
	"Antic": {
		"family": "Antic",
		"category": "sans-serif",
	...
	"Arimo": {
		...
		"category": "sans-serif",
		"variants": ["regular", "italic", "700", "700italic"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "vietnamese", "greek-ext", "hebrew", "latin", "greek"]
	},
	"Arizonia": {
		"family": "Arizonia",
		"category": "handwriting",
	...
	"Comfortaa": {
		...
		"category": "display",
		"variants": ["300", "regular", "700"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "latin", "greek"]
	},
	"Coming Soon": {
		"family": "Coming Soon",
		"category": "handwriting",
	...
	"Didact Gothic": {
		...
		"category": "sans-serif",
		"variants": ["regular"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "greek-ext", "latin", "greek"]
	},
	"Diplomata": {
		"family": "Diplomata",
		"category": "display",
	...
	"EB Garamond": {
		...
		"category": "serif",
		"variants": ["regular"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "vietnamese", "latin"]
	},
	"Eagle Lake": {
		"family": "Eagle Lake",
		"category": "handwriting",
	...
	"Kurale": {
		...
		"category": "serif",
		"variants": ["regular"],
		"subsets": ["latin-ext", "cyrillic", "latin", "devanagari"]
	},
	"La Belle Aurore": {
	...
	"Lobster": {
		...
		"category": "display",
		"variants": ["regular"],
		"subsets": ["latin-ext", "cyrillic", "vietnamese", "latin"]
	},
	"Lobster Two": {
		"family": "Lobster Two",
		"category": "display",
	...
	"Noto Sans": {
		...
		"category": "sans-serif",
		"variants": ["regular", "italic", "700", "700italic"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "vietnamese", "greek-ext", "latin", "devanagari", "greek"]
	},
	"Noto Serif": {
		"family": "Noto Serif",
		"category": "serif",
		"variants": ["regular", "italic", "700", "700italic"],
		"subsets": ["latin-ext", "cyrillic", "cyrillic-ext", "vietnamese", "greek-ext", "latin", "greek"]
	},
	"Nova Cut": {
		"family": "Nova Cut",
		"category": "display",
	...
	"Rubik": {
		...
		"subsets": ["cyrillic", "hebrew", "latin-ext"]
	},
	"Rubik Mono One": {
